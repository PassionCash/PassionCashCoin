...
The build script we'll be using is contained in the Passion github repository ([contrib/gitian-build.py](https://github.com/passion-project/passion/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the Passion repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Passion-Project/Passion/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, passion-detached-sigs, and passion GitHub repos.
