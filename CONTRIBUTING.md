Contributing to Passion Core
============================

The Passion Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/passion-project/passion/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Passion Core project, and is not to be
confused with overall Passion Network Protocol consensus changes.

Whether a pull request is merged into Passion Core rests with the project merge
...
Patches that change Passion consensus rules are considerably more involved than
...
Where a patchset proposes to change the Passion consensus, it must have been
...
The project leader is the release manager for each Passion Core release.
